...
//    }
    ...
    public void ewtsFilterTest() throws IOException {
        ...
        expected = Arrays.asList("དཔལ", "ལྡན", "ན", "རོ", "པའི", "རྣམ");
        System.out.print(input + " => ");
        ...
        // case-insensitive Wylie as ewts
        input = "Rje sTong rTen Rnying rNying rJe";
        reader = new StringReader(input);
        expected = Arrays.asList("རྗེ", "སྟོང", "རྟེན", "རྙིང", "རྙིང", "རྗེ");
        System.out.print(input + " => ");
        res = tokenize(new TibEwtsFilter(reader), new TibSyllableTokenizer());
        assertTokenStream(res, expected);
        ...
        System.out.print(input + " => ");
        res = tokenize(new TibEwtsFilter(reader, "dts", true), new TibSyllableTokenizer());
        assertTokenStream(res, expected);
        // alalc
        input = "Ri-gi-ā-ra";
        reader = new StringReader(input);
        ...
        System.out.print(input + " => ");
        res = tokenize(new TibEwtsFilter(reader, "alalc", true), new TibSyllableTokenizer());
