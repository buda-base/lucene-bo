...
public class PhoneticSystemStandardTibetan extends PhoneticSystem {
    ...
    public PhoneticSystemStandardTibetan() {
        ...
        this.addVowelCoda("ུའུ", "uu");
        this.addVowelCoda("ུའུའི", "uui");
        this.addVowelCoda("ུའུའིའོ", "uuio");
        this.addVowelCoda("ུའུའོ", "uuo");
        this.addVowelCoda("ུའུའང", "uuang");
        this.addVowelCoda("ུའུའམ", "uuam");
